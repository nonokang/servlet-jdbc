	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item"><a href="javascript:;" class="_url" data-url="<%=request.getContextPath()%>/peopleIndex.html">主页</a></li>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-nav-itemed">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" class="_url" data-url="<%=request.getContextPath()%>/peopleIndex.html">模板功能</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" class="_url" data-url="<%=request.getContextPath()%>/peopleIndex.html">用户管理</a>
							</dd>
							<dd>
								<a href="javascript:;" class="_url" data-url="<%=request.getContextPath()%>/peopleIndex.html">日志管理</a>
							</dd>
						</dl>
					</li>
				</ul>
		...
		<div class="layui-body" style="bottom: 0px;">
			<iframe id="myframe" src="<%=request.getContextPath()%>/peopleIndex.html" width="100%" height="100%" frameborder="0"></iframe>
		</div>
	</div>
