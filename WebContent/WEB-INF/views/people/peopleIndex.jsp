...
//			  ,width: '100%'	//默认自动调整
			  ...
			  ,url: '/servlet-jdbc/peopleList.html'	//异步获取数据
			  ,cols: [[
		  ...
		  table.on('tool(table-filter)', function(obj){
		    ...
		    if(obj.event === 'del'){//删除
		      layer.confirm('是否确认删除？', function(index){
	              ...
	              $.ajax({
	                    type: 'delete',
	                    url: '/servlet-jdbc/peopleOpera.html?ids='+_ids.join(','),
	                    dataType: 'json',
// 	                    data: {id : data.id},//使用delete类型时，data传递参数无效
		        ...
		        layer.open({
		          ...
		          ,maxmin: true
		          ,offset: [50,0] //模态框坐标
		          ,content: '/servlet-jdbc/peopleOpera.html?id='+data.id
		         /*  ,btn: ['保存', '关闭'] //只是为了演示
...
//	 	                    data: {id : data.id},//使用delete类型时，data传递参数无效
		  	...
		  	addData: function(){
		        layer.open({
			          ...
			          ,maxmin: true
			          ,offset: [50,0] //模态框坐标
			          ,content: '/servlet-jdbc/peopleOpera.html'
			        });
		  	}
		    ,reload: function(){
